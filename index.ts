...
const funcionario1 = new Funcionario("João", "123.456.789-00", new Date(1990, 5, 15), new Apartamento("C", 303, "Fulano de Tal"), "123456789", "987654321", "j@j.com", cargoZelador, 3000)
const funcionario2 = new Funcionario("Maria", "987.654.321-00", new Date(1985, 3, 20), new Apartamento("D", 404, "Ciclano de Tal"), "987654321", "123456789", "ma@m.com", cargoZelador, 3200)

const apartamento1 = new Apartamento("A", 101, "Fulano de Tal")
const apartamento2 = new Apartamento("B", 202, "Ciclano de Tal")

const morador1 = new Morador("Carlos", "111.222.333-44", new Date(1988, 10, 25), apartamento1, "333333333", "999999999", "c@c.com")
const morador2 = new Morador("Ana", "555.666.777-88", new Date(2009, 7, 12), apartamento1, "444444444", "888888888", "a@a.com")
const morador3 = new Morador("Paulo", "999.888.777-66", new Date(2005, 2, 8), apartamento2, "555555555", "777777777", "p@p.com")
const morador4 = new Morador("Joao", "999.888.777-66", new Date(2008, 2, 8), apartamento2, "66666666", "999999999", "j@j.com")
